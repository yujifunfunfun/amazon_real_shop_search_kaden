...
def fetch_biccamera_edion_kojima_data(model_number_list,amazon_price_url_name_list):
    user_agent = [
...
def main():
    ...
    p0 = multiprocessing.Process(target=fetch_biccamera_edion_kojima_data,args=(model_number_list,amazon_price_url_name_list))
